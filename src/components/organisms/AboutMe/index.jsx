...
const AboutMe = () => {
  return (
    <MainContainer>
      ...
      <RightSideTextBlock>
        <RightParagraph>
          Welcome! I am a jewelry designer and silversmith with a passion for creating unique and meaningful pieces of jewelry.
        </RightParagraph>
        <RightParagraph>
          I am the founder of{' '}
          <Link href={'https://AnvilandEmberMetalworks.etsy.com'} target='_blank'>
            {' Anvil and Ember on Etsy'}
          </Link>
        ...
        <RightParagraph>
          In addition to my work in jewelry design, I also have a background in computers, fabrication, and graphic design. I recently graduated from
          California State University, East Bay with a Bachelor of Science in Computer Science and have experience in developing websites using
          HTML, CSS, JavaScript, React and Nodejs. Additionally I have experience with several programming languages including C++, Java, Python, and more.
        </RightParagraph>
        <RightParagraph>
          In the 
